...
export default class CreditCardInput extends Component {
  static propTypes = {
    ...
    customCardImageFront: PropTypes.string,
    customCardImageBack: PropTypes.string,
    ...
    return (
      <View style={s.container}>
        <CreditCard
          ...
          expiry={expiry}
          cvc={cvc}
          custonImageFront={customCardImageFront}
          customImageBack={customCardImageBack}
        />
        <ScrollView
          ref="Form"
          horizontal
